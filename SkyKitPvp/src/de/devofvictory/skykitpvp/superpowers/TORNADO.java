...
import de.devofvictory.skykitpvp.objects.TornadoObj;
import de.devofvictory.skykitpvp.utils.KitManager;
import de.devofvictory.skykitpvp.utils.LevelBarUtil;

public class TORNADO implements SuperPowerExecutor{
	...
	public void runSuperPower(Player p) {
		...
		TornadoObj.spawnTornado(p, Main.getInstance(), targetBlock.getLocation().clone().add(0,2,0), Material.STONE, (byte) 0, null, 0.3, 100, duration*20, false, false);
